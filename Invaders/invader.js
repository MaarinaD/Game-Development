...
function createPlayer(){
 ...
 function movePlayer(){
    ...
    //дали бутона е натиснат
    if (fireButton.isDown)
    {
        //да се задейства функцията
        fireBullet();
    }
//дали имаме още останали 
...
function setupInvader (invader) {
    ...
    invader.animations.add('expl'); //да се задейства анимацията
}
...
//tween = dava ni pravo da promenqme nqkoi swojstwa na opredelen obekt za opredelen interwal 
// 2000 otbroqwane na updajtite
let tween = Game.add.tween(aliens).to({x:200}, 2000,
 ...
 function collisionHandler(bullet, alien) {
    ...
    //false za]oto iskame da eksplodira samo pri wzaimodejstwieto
    let explosion = explosions.getFirstExists(false)

    explosion.reset(alien.body.x, alien.body.y)
    explosion.play('expl', 30, false, true)

    //dali imame o]e izwynzemni za da ni izpi[e winner
    if (aliens.countLiving() == 0)
    {
        ...
        //igrata da zapo`ne otnowo
        //this otkriwa sam za koe se otnasq
        Game.input.onTap.addOnce(restart, this)
    }
 }

 //aко имаме животи играта да продължи, ако не- да започне отново
 function enemyHitsPlayer (player, bullet) {
    ...
    if (lives.countLiving()<1)
    {
        ...
        //kogato stignem do game over da zapochnem otnachalo
        Game.input.onTap.addOnce(restart, this)
